  ...
  return (
    <div className='home-container'>
      ...
      <div className='about-section'>
        ...
        <div>
          BluePeak Solutions is a leading IT company specializing in delivering
          cutting-edge technology services to businesses worldwide. With a
          passionate team of experts, we help organizations transform digitally,
          optimize operations, and achieve sustainable growth. Our commitment to
        ...
        <div className='services-list'>
          <div className='service-card'>
            ...
            <div className='service-desc'>
              Tailored web, mobile, and desktop applications built to solve your
          ...
          <div className='service-card'>
            ...
            <div className='service-desc'>
              Strategic technology consulting to align IT initiatives with your
          ...
          <div className='service-card'>
            ...
            <div className='service-desc'>
              Engaging and user-friendly interfaces designed to enhance customer
